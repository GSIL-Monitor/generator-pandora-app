...
import WebpackPluginHashOuput from 'webpack-plugin-hash-output'
import {BundleAnalyzerPlugin} from 'webpack-bundle-analyzer'
import pkg from '../package.json'

// const isDebug = !process.argv.includes('--release')
const env = ['development', 'test', 'staging', 'production'].indexOf(process.env.NODE_ENV) < 0 ? 'development' : process.env.NODE_ENV
...
const clientConfig = {
  ...
  plugins: [
    ...
    ...isDebug ? [] : [
      ...
      // https://github.com/scinos/webpack-plugin-hash-output
      new WebpackPluginHashOuput(),
